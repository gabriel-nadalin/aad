...
SIGNAL \inst3|altsyncram_component|auto_generated|address_reg_a[2]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \inst2|Equal1~1_combout\ = ((\inst2|Equal1~0_combout\) # ((\inst2|h_count\(5)) # (!\inst2|h_count\(9)))) # (!\inst2|Equal0~0_combout\)
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode80w[3]~0_combout\ = (!\inst2|pixel_row\(6) & (\inst2|pixel_row\(5) & !\inst2|pixel_row\(4)))
...
-- Equation(s):
-- \inst2|Equal0~2_combout\ = (!\inst2|h_count\(3) & (\inst2|h_count\(5) & (!\inst2|h_count\(4) & !\inst2|h_count\(7))))
...
-- Equation(s):
-- \inst2|Equal0~0_combout\ = (!\inst2|h_count\(1) & (!\inst2|h_count\(6) & (!\inst2|h_count\(2) & !\inst2|h_count\(0))))
...
-- Equation(s):
-- \inst2|h_count~3_combout\ = (\inst2|Add0~0_combout\ & (((!\inst2|Equal0~1_combout\) # (!\inst2|h_count\(8))) # (!\inst2|Equal0~2_combout\)))
...
-- Equation(s):
-- \inst2|process_0~2_combout\ = (!\inst2|h_count\(5) & (!\inst2|h_count\(6) & ((!\inst2|h_count\(4)) # (!\inst2|h_count\(3)))))
...
-- Equation(s):
-- \inst2|process_0~10_combout\ = (((!\inst2|h_count\(8) & !\inst2|h_count\(7))) # (!\inst2|v_count\(9))) # (!\inst2|h_count\(9))
...
-- Equation(s):
-- \inst2|v_count~0_combout\ = (\inst2|Add1~2_combout\ & ((\inst2|process_0~10_combout\) # ((\inst2|LessThan1~2_combout\) # (\inst2|process_0~9_combout\))))
...
-- Equation(s):
-- \inst2|LessThan1~1_combout\ = (!\inst2|v_count\(4) & (!\inst2|v_count\(7) & (!\inst2|v_count\(6) & !\inst2|v_count\(5))))
...
-- Equation(s):
-- \inst2|LessThan1~2_combout\ = (\inst2|LessThan1~1_combout\ & (!\inst2|v_count\(8) & \inst2|LessThan1~0_combout\))
...
-- Equation(s):
-- \inst2|LessThan6~0_combout\ = (\inst2|v_count\(6) & (\inst2|v_count\(7) & (\inst2|v_count\(8) & \inst2|v_count\(5))))
...
-- Equation(s):
-- \inst2|LessThan6~1_combout\ = (\inst2|v_count\(2)) # ((\inst2|v_count\(1)) # ((\inst2|v_count\(3)) # (\inst2|v_count\(0))))
...
-- Equation(s):
-- \inst~0_combout\ = (!\inst2|pixel_column\(8) & (!\inst2|pixel_row\(7) & (!\inst2|pixel_row\(8) & \inst2|video_on_v~regout\)))
...
-- Equation(s):
-- \inst1~combout\ = LCELL((\inst2|video_on_h~regout\ & (!\inst2|pixel_column\(9) & (GLOBAL(\inst2|video_PLL_inst|altpll_component|_clk0~clkctrl_outclk\) & \inst~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|video_on_h~regout\,
	datab => \inst2|pixel_column\(9),
	datac => \inst2|video_PLL_inst|altpll_component|_clk0~clkctrl_outclk\,
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode90w[3]~0_combout\ = (!\inst2|pixel_row\(6) & (\inst2|pixel_row\(5) & \inst2|pixel_row\(4)))
...
\inst2|pixel_column[2]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
...
PORT MAP (
	clk => \inst2|video_PLL_inst|altpll_component|_clk0~clkctrl_outclk\,
	datain => \inst2|pixel_column[2]~feeder_combout\,
	ena => \inst2|LessThan5~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\inst2|pixel_row[1]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|altsyncram_component|auto_generated|ram_block1a2~portadataout\,
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|mux2|_~3_combout\ = (\inst3|altsyncram_component|auto_generated|mux2|_~2_combout\ & (((\inst3|altsyncram_component|auto_generated|ram_block1a3~portadataout\) # 
-- (!\inst3|altsyncram_component|auto_generated|out_address_reg_a\(0))))) # (!\inst3|altsyncram_component|auto_generated|mux2|_~2_combout\ & (\inst3|altsyncram_component|auto_generated|ram_block1a1~portadataout\ & 
-- ((\inst3|altsyncram_component|auto_generated|out_address_reg_a\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|altsyncram_component|auto_generated|ram_block1a1~portadataout\,
	datab => \inst3|altsyncram_component|auto_generated|ram_block1a3~portadataout\,
...
\inst3|altsyncram_component|auto_generated|address_reg_a[2]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|address_reg_a[2]~feeder_combout\ = \inst2|pixel_row\(6)
...
PORT MAP (
	...
	combout => \inst3|altsyncram_component|auto_generated|address_reg_a[2]~feeder_combout\);

-- Location: LCFF_X20_Y21_N27
\inst3|altsyncram_component|auto_generated|address_reg_a[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \inst1~clkctrl_outclk\,
	datain => \inst3|altsyncram_component|auto_generated|address_reg_a[2]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode130w[3]~0_combout\ = (\inst2|pixel_row\(6) & (\inst2|pixel_row\(5) & \inst2|pixel_row\(4)))
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode110w[3]~0_combout\ = (\inst2|pixel_row\(6) & (!\inst2|pixel_row\(5) & \inst2|pixel_row\(4)))
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode100w[3]~0_combout\ = (!\inst2|pixel_row\(5) & (!\inst2|pixel_row\(4) & \inst2|pixel_row\(6)))
...
PORT MAP (
	...
	datab => \inst3|altsyncram_component|auto_generated|ram_block1a5~portadataout\,
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|deep_decode|w_anode120w[3]~0_combout\ = (\inst2|pixel_row\(6) & (\inst2|pixel_row\(5) & !\inst2|pixel_row\(4)))
...
-- Equation(s):
-- \inst3|altsyncram_component|auto_generated|mux2|_~1_combout\ = (\inst3|altsyncram_component|auto_generated|out_address_reg_a\(1) & ((\inst3|altsyncram_component|auto_generated|mux2|_~0_combout\ & 
-- (\inst3|altsyncram_component|auto_generated|ram_block1a7~portadataout\)) # (!\inst3|altsyncram_component|auto_generated|mux2|_~0_combout\ & ((\inst3|altsyncram_component|auto_generated|ram_block1a6~portadataout\))))) # 
-- (!\inst3|altsyncram_component|auto_generated|out_address_reg_a\(1) & (((\inst3|altsyncram_component|auto_generated|mux2|_~0_combout\))))
...
PORT MAP (
	...
	datac => \inst3|altsyncram_component|auto_generated|mux2|_~0_combout\,
...
-- Equation(s):
-- \inst~1_combout\ = (!\inst2|pixel_column\(9) & (\inst2|video_on_h~regout\ & (\inst~0_combout\ & \inst7~regout\)))
